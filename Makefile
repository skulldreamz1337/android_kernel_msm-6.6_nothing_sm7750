...
# ifdef Nothing Project
KBUILD_CFLAGS   +=   -DNT_PROJECT=\"$(NT_PROJECT)\"
KBUILD_CPPFLAGS +=   -DNT_PROJECT=\"$(NT_PROJECT)\"
CFLAGS_KERNEL   +=   -DNT_PROJECT=\"$(NT_PROJECT)\"
CFLAGS_MODULE   +=   -DNT_PROJECT=\"$(NT_PROJECT)\"
# endif
